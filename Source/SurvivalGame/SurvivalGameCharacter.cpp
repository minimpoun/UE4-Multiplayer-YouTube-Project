...
void ASurvivalGameCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindTouch(IE_Pressed, this, &ASurvivalGameCharacter::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &ASurvivalGameCharacter::TouchStopped);
...
{
	// If SurvivalGame is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in SurvivalGame.Build.cs is not automatically propagated
